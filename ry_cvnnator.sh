...
FILE=$1
BAMFILE='/Users/ry00555/Desktop/RochelleLabDesktopData/IGV/mus30xmei3/Bamfiles/'
REF='/Users/ry00555/Desktop/NeurosporaGenome/GCF_000182925.2.fasta'
CHROM='/Users/ry00555/Desktop/NeurosporaGenome/Chromsomes/Chr*.fa'
...
cnvnator -root ${FILE}.root -chrom $CHROM -tree -d $REF $BAMFILE*.bam

  cnvnator -root ${FILE}.root -chrom $CHROM -his 1670 -fasta -d $REF
  cnvnator -root ${FILE}.root -chrom $CHROM -stat 1670 -d $REF
  cnvnator -root ${FILE}.root -chrom $CHROM -eval 1670 -d $REF
  cnvnator -root ${FILE}.root -chrom $CHROM -partition 1670 -d $REF
 #cnvnator -root ${FILE}.root -genotype 1670
 #cnvnator -root ${FILE}.root -view 1670
 cnvnator -root ${FILE}.root -chrom $CHROM -call 1670 > ${BAMFILE}_cnv_longbin
